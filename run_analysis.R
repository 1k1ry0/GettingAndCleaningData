setwd("C:\\Users\\Ikiryo\\Desktop\\R playground\\project2\\UCI HAR Dataset")
...
#feed in test data, renaming column names based on ColNames vector. load activity codes and subjects and bind all three together
...
#feed in train data, renaming column names based on ColNames vector. load activity codes and subjects and bind all three together
